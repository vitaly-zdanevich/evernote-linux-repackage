...
Validated with Evernote `11.22.4` from `https://win.desktop.evernote.com/builds/Evernote-latest.exe`:
...
- ENEX import workflow. ENEX import is handled by the desktop app; Evernote Web does not provide the same ENEX restore workflow. See [How To: Import Notes and Notebooks](https://help.evernote.com/hc/en-us/articles/360035153274-How-To-Import-Notes-and-Notebooks).
...
EVERNOTE_SHA256=601552957eaa1394a93df483f93ad61582a298b7f202f3fb89b56cc02d3fc0dd \
EVERNOTE_EXPECTED_VERSION=11.22.4 \
